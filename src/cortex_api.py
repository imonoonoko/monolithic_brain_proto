...
class CortexBrainAPI:
    ...
    """
    def __init__(self, brain_path: str = config.BRAIN_FILENAME, model_path: str = config.MODEL_FILENAME):
    ...
    def think(self, player_input: str, game_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Main cognitive step.
        Args:
